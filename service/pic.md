...
图片处理服务仅在下载时触发，只有北京和上海地域支持像素10000*10000的图片处理请求，图片处理不支持range参数，加range参数会返回整个图片，乌兰察布不支持外网水印，需要使用需将图片上传对应地域US3,图片水印的imageurl时候使用内网域名url，若其他地域有图片处理需求，请联系技术支持。

|   图片处理    |  支持地域                                                                    | 功能                   |
| ----------    | --------------------------------------------------------------------------- | -------------------------- |
|    所有地域     | 北京、上海、台北、香港、广州、迪拜、新加坡、胡志明、洛杉矶、拉各斯、乌兰察布、首尔和伦敦   |                            |
| 地域            | 北京、上海、台北、新加坡、乌兰察布、迪拜、广州和伦敦                                 | 支持所有功能                |
| 地域            | 香港、胡志明、洛杉矶、拉各斯和首尔                                                | 支持：基本图片信息获取、EXIF 信息获取、图片缩放、裁剪、旋转、水印、格式转换等基本功能                    |
